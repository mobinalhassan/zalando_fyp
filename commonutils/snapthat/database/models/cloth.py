...
class ClothModel(AbstractDBModel):
    def __init__(self):
        super().__init__()
        ...
        self.crawling_source_name = ""
        self.crawling_source_url = ""
    ...
    def is_valid(self):
        ...
        self.check_list_of_strings(['zoomedpics', 'otherpics', 'colors','processed_colors','dressattributes' , 'dressdecorations', 'dresstags','processed_dresstags',  'faceflags',
    ...
    def preprocess(self):
        ...
        self.source = format_url(self.source)
        self.checkoutsource = format_url(self.checkoutsource)

        self.crawling_source_url = format_url(self.crawling_source_url)
    ...
    def required(self):
        return ['gender', 'brand_name', 'availability', 'price', 'title', 'thumbnail', 'source']
    ...
    def indexes(self):
        ...
        return [FieldIndex("source", unique=True), lat_lng_comp, FieldIndex("brand_name"), FieldIndex("price"),
                FieldIndex("gender"), FieldIndex("quantity"), FieldIndex("season"), FieldIndex("created_at"),
                FieldIndex("updated_at"), FieldIndex("availability"), FieldIndex("images_saved"), FieldIndex("indexed"),
                created_updated_comp]

    def ignore(self):
        return ['currency', 'thumbnail','frontpic', 'backpic', 'leftpic', 'rightpic', 'source',
                'checkoutsource', 'crawling_source_url', 'zoomedpics', 'otherpics']
